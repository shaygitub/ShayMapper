...
BOOL VulnurableDriver::IoctlFunctions::MemoryWrite(HANDLE* DeviceHandle, PVOID WriteToAddress, PVOID WriteFromAddress, ULONG64 WriteSize) {
	return MemoryCopy(DeviceHandle, WriteToAddress, WriteFromAddress, WriteSize);
}
